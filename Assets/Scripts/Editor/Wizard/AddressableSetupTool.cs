...
namespace Sc.Editor.Wizard
{
    ...
    public static class AddressableSetupTool
    {
        ...
        [MenuItem("SC Tools/Addressables/Setup UI Groups", priority = 500)]
        public static void SetupUIGroups()
        {
            ...
            if (settings == null)
            {
                Debug.LogError("[AddressableSetupTool] Addressables Settings를 찾을 수 없습니다. Window > Asset Management > Addressables > Groups에서 생성하세요.");
                return;
            }
        ...
        [MenuItem("SC Tools/Addressables/Clear UI Groups", priority = 501)]
        ...
        [MenuItem("SC Tools/Addressables/Validate UI Groups", priority = 502)]
